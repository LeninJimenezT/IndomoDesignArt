...
export default function Modelos () {
    ...
    function fondo(CX,CY,displayX,displayY){
        ...
        if (fondo) {
            var cyi= (displayY-CY)*0.07;
            var czi= (-3*CY)/displayY + 3;

            document.documentElement.style.setProperty('--fy-e', '-' + CY + 'px');
            document.documentElement.style.setProperty('--fx-m', '-' + (displayX-CX) + 'px');                
            document.documentElement.style.setProperty('--fy-m', '-' + (displayY-CY) + 'px');                
            document.documentElement.style.setProperty('--fy-i', '-' + cyi + 'px');
            document.documentElement.style.setProperty('--fz-i', '-' + czi + 'px');
        ...
        window.addEventListener('mousemove', function(e) {
            ...
            */
            if ((e.clientX > 0) && (e.clientX+size*3.5 < displayX)) {
                cursor.style.left = e.clientX+size*3.5-20+'px';
            }
            if (e.clientY+size*2 < displayY) {
                cursor.style.top = e.clientY+size*2-15+'px';
            }
            loop();
    ...
    return(
        <div className='modelo-container'>
            ...
            <div className='fondo-media-e'></div>
            <div className='fondo-media-m'></div>
            <div className='fondo-media-i'></div>
            <div className='fondo-media-i2'></div>
